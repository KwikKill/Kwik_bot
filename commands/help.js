...
module.exports = {
    ...
    async autocomplete(client, interaction) {
        ...
        let cmds = [];
        client.commands.filter(cmd => client.canRunCommande(undefined, cmd, interaction) && cmd.name.startsWith(focusedValue) && (cmd.serverid === undefined || cmd.serverid?.includes(interaction.guild.id))).forEach(cmd => {
