    ...
    async run(message, client, interaction = undefined) {
        ...
        if (interaction.options.getSubcommandGroup() === "account") {
            ...
            if (interaction.options.getSubcommand() === "summarized") {
                ...
                let text = "```" +
                    "─────────────────────┬─────────────────────\n";
                text += "Average Kills        │ " + Number.parseFloat(average_kills).toFixed(2) + " ".repeat(7 - Number.parseFloat(average_kills).toFixed(2).length);
                ...
                text += "Average Deaths       │ " + Number.parseFloat(average_deaths).toFixed(2) + " ".repeat(7 - Number.parseFloat(average_deaths).toFixed(2).length);
                ...
                text += "Average Assists      │ " + Number.parseFloat(average_assists).toFixed(2) + " ".repeat(7 - Number.parseFloat(average_assists).toFixed(2).length);
                ...
                text += "Average CS           │ " + Number.parseFloat(average_cs).toFixed(2) + " ".repeat(7 - Number.parseFloat(average_cs).toFixed(2).length);
                ...
                text += "Average Gold         │ " + Number.parseFloat(average_gold).toFixed(2) + " ".repeat(7 - Number.parseFloat(average_gold).toFixed(2).length);
                ...
                text += "Average Damages      │ " + Number.parseFloat(average_damages).toFixed(2) + " ".repeat(7 - Number.parseFloat(average_damages).toFixed(2).length);
                ...
                text += "Average Tanked       │ " + Number.parseFloat(average_tanked).toFixed(2) + " ".repeat(7 - Number.parseFloat(average_tanked).toFixed(2).length);
                ...
                text += "Average Pinks        │ " + Number.parseFloat(average_pinks).toFixed(2) + " ".repeat(7 - Number.parseFloat(average_pinks).toFixed(2).length);
                ...
                text += "Average Vision Score │ " + Number.parseFloat(average_vision_score).toFixed(2) + " ".repeat(7 - Number.parseFloat(average_vision_score).toFixed(2).length);
                ...
                text += "Average KP           │ " + Number.parseFloat((Number.parseFloat(average_kills) + Number.parseFloat(average_assists)) * 100 / average_total_kills).toFixed(2) + " ".repeat(7 - Number.parseFloat((Number.parseFloat(average_kills) + Number.parseFloat(average_assists)) * 100 / average_total_kills).toFixed(2).length);
                ...
                text += "Score                │ " + Number.parseFloat(score).toFixed(2) + " ".repeat(7 - Number.parseFloat(score).toFixed(2).length);
                ...
                text += "Carry Gold           │ " + Number.parseFloat(carry_gold).toFixed(2) + " ".repeat(7 - Number.parseFloat(carry_gold).toFixed(2).length);
                ...
                text += "Carry Damage         │ " + Number.parseFloat(carry_damage).toFixed(2) + " ".repeat(7 - Number.parseFloat(carry_damage).toFixed(2).length);
                ...
                text += "Carry Tanked         │ " + Number.parseFloat(carry_tanked).toFixed(2) + " ".repeat(7 - Number.parseFloat(carry_tanked).toFixed(2).length);
                ...
                text += "Hard Carry           │ " + Number.parseFloat(hard_carry).toFixed(2) + " ".repeat(7 - Number.parseFloat(hard_carry).toFixed(2).length);
                ...
                text += "Overall              │ " + Number.parseFloat(overall).toFixed(2) + " ".repeat(7 - Number.parseFloat(overall).toFixed(2).length);
